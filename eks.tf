...
module "eks" {
  ...
  eks_managed_node_groups = {
    production-ng = {
      ...
      min_size                 = lookup(var.eks_production_node_group, "min_size", 1)
      max_size                 = lookup(var.eks_production_node_group, "max_size", 2)
      desired_size             = lookup(var.eks_production_node_group, "desired_size", 1)
